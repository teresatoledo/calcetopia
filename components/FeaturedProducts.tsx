        ...
        <CarouselContent className="-ml-2 md:-ml-4" >
          ...
          {result !== null && (
            result.map((product: ProductType, index: number)=> {
              ...
              return (
                <CarouselItem key={id} className="md:basis-1/2 lg:basis-1/3 group" onMouseEnter={() => setHovered(index)}
                  ...
                  <div className="p-1">
                    <Card className="py-4 border border-gray-200 shadow-none" >
                      ...
                      <div className="flex justify-between gap-4 px-8">
                        ...
                        <p className="text-md font-bold">{formatPrice(product.attributes.price)}</p>
                      </div>
                    </Card>
                  </div>
