        ...
        <footer className="mt-4">
            <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                <div className="flex items-center justify-between flex-col sm:flex-row">
                    <div className="flex gap-10 items-center justify-center pl-4">
                        <Image
                            src={logo}
                    ...
                    <ul className="flex flex-col sm:flex-row flex-wrap items-center mb-6 mt-4 text-sm font-medium text-gray-500 sm:mb-0 dark:text-gray-400">
                        {dataFooter.map((data) => (
                            <li key={data.id}>
                                <Link
                                    href={data.link}
